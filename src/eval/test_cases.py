...
GOLDEN_CASES: list[GoldenCase] = [
    GoldenCase(
        ...
        revenue_min=370_000_000_000,      # FY2024–FY2025 TTM range
        revenue_max=470_000_000_000,
        net_income_min=88_000_000_000,     # FY2024 ~$94B, FY2025 TTM ~$117B
        net_income_max=125_000_000_000,
        gross_margin_min=0.43,             # ~46–47%
    ...
    GoldenCase(
        ...
        revenue_min=55_000_000_000,        # FY2024 ~$61B; FY2025 TTM ~$215B
        revenue_max=230_000_000_000,
        net_income_min=15_000_000_000,
        net_income_max=125_000_000_000,    # FY2025 TTM ~$120B
        gross_margin_min=0.60,             # data center mix → ~71%
    ...
    GoldenCase(
        ...
        revenue_min=200_000_000_000,       # FY2024 ~$245B; FY2025 TTM ~$305B
        revenue_max=320_000_000_000,
        net_income_min=70_000_000_000,
        net_income_max=125_000_000_000,    # FY2025 TTM ~$119B
        gross_margin_min=0.68,             # ~68–70%
        gross_margin_max=0.76,
        eps_min=9.0,
        eps_max=17.5,                      # FY2025 TTM ~$15.96
        dte_min=0.0,
        dte_max=1.0,
        required_rag_keywords=[
            "azure",
